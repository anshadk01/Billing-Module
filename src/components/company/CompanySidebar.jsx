...
const CompanySidebar = () => {
  ...
  const navItems = [
    { to: "/company-dashboard", icon: <Home size={18} />, label: "Dashboard" },
    { to: "/company/invoices", icon: <FileText size={18} />, label: "Invoices Inbox" },
    { to: "/company/payment", icon: <Wallet size={18} />, label: "Payment Interface" },
  ];
